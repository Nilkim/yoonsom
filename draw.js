...
function drawLubasAndMoldings(ctx, inputWidth, rectWidth, rectHeight, startX, startY, heightRatio) {
    ...
    for (let i = 0; i < numberOfMoldings; i++) {
        setTimeout(() => {
            ...
            ctx.fillRect(startX + i * (rectWidth * (moldingWidthReal / inputWidth)), startY, moldingWidth, rectHeight * (moldingHeightReal / heightRatio));
            ctx.strokeStyle = 'black';
            ctx.lineWidth = 0.5;
            ctx.strokeRect(startX + i * (rectWidth * (moldingWidthReal / inputWidth)), startY, moldingWidth, rectHeight * (moldingHeightReal / heightRatio));
